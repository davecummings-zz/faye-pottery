    ...
    <>
      <div className="bg-glaze text-white py-12">
        <div className="max-w-6xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-serif font-bold">About Faye</h1>
        </div>
      </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-4xl font-serif font-bold text-clay mb-6">My Story</h2>
            ...
            <div className="relative h-96 rounded-lg overflow-hidden shadow-lg">
              <Image
                src="https://images.unsplash.com/photo-1579783902614-e3fb5141b0cb?w=600&h=600&fit=crop"
          ...
          {/* Values */}
          <div className="bg-sand rounded-lg p-12 mb-16">
            <h3 className="text-3xl font-serif font-bold text-clay mb-8 text-center">My Values</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-4xl mb-4">♻️</div>
                <h4 className="font-bold text-clay mb-3">Sustainability</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-bold text-clay mb-3">Craftsmanship</h4>
                <p className="text-earth">
              ...
              <div className="text-center">
                <div className="text-4xl mb-4">❤️</div>
                <h4 className="font-bold text-clay mb-3">Connection</h4>
                <p className="text-earth">
          ...
          {/* CTA */}
          <div className="text-center">
            <h3 className="text-3xl font-serif font-bold text-clay mb-6">Ready to Find Your Favorite Piece?</h3>
